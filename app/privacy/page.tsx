    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/privacy" className="text-[#2F3A40] hover:text-[#3B82F6] px-3 py-2 rounded-md text-sm font-medium">
                  Privacy
                </Link>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold text-[#2F3A40] mb-4">Privacy Policy</h1>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-[#6B7280] mb-6">
            Inova Adv ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our SMS verification service and website.
          </p>
          ...
          <h3 className="text-xl font-semibold text-[#2F3A40] mt-6 mb-3">2.2 Information Collected Automatically</h3>
          <p className="text-[#6B7280] mb-4">When you use our verification service, we automatically collect:</p>
          <ul className="list-disc pl-6 text-[#6B7280] mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">3. How We Use Your Information</h2>
          <p className="text-[#6B7280] mb-4">We use the information we collect to:</p>
          <ul className="list-disc pl-6 text-[#6B7280] mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">4. Information Sharing and Disclosure</h2>
          <p className="text-[#6B7280] mb-4">We may share your information with:</p>
          
          <h3 className="text-xl font-semibold text-[#2F3A40] mt-6 mb-3">4.1 Service Providers</h3>
          <p className="text-[#6B7280] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[#2F3A40] mt-6 mb-3">4.2 Business Transfers</h3>
          <p className="text-[#6B7280] mb-6">
            In connection with any merger, sale of company assets, financing, or acquisition of all or a portion of our business.
          </p>

          <h3 className="text-xl font-semibold text-[#2F3A40] mt-6 mb-3">4.3 Legal Requirements</h3>
          <p className="text-[#6B7280] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[#2F3A40] mt-6 mb-3">4.4 With Your Consent</h3>
          <p className="text-[#6B7280] mb-6">
            We may share your information for any other purpose with your explicit consent.
          </p>

          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">5. Data Security</h2>
          <p className="text-[#6B7280] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">6. Data Retention</h2>
          <p className="text-[#6B7280] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">7. Your Rights and Choices</h2>
          <p className="text-[#6B7280] mb-4">Depending on your location, you may have the following rights:</p>
          <ul className="list-disc pl-6 text-[#6B7280] mb-6 space-y-2">
          ...
          <p className="text-[#6B7280] mb-6">
            To exercise these rights, please contact us at <a href="mailto:privacy@inovaadv.com" className="text-[#3B82F6] hover:text-[#1d4ed8]">privacy@inovaadv.com</a>.
          </p>
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">9. Third-Party Links</h2>
          <p className="text-[#6B7280] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">10. Children's Privacy</h2>
          <p className="text-[#6B7280] mb-6">
            Our service is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If you believe we have collected information from a child, please contact us immediately.
          </p>

          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">11. International Data Transfers</h2>
          <p className="text-[#6B7280] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">12. California Privacy Rights</h2>
          <p className="text-[#6B7280] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">13. Changes to This Privacy Policy</h2>
          <p className="text-[#6B7280] mb-6">
            We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date. You are advised to review this Privacy Policy periodically for any changes.
          </p>

          <h2 className="text-2xl font-bold text-[#2F3A40] mt-8 mb-4">14. Contact Us</h2>
          <p className="text-[#6B7280] mb-4">
            If you have any questions about this Privacy Policy or our privacy practices, please contact us:
          </p>
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-[#6B7280] mb-2"><strong>Email:</strong> <a href="mailto:privacy@inovaadv.com" className="text-[#3B82F6] hover:text-[#1d4ed8]">privacy@inovaadv.com</a></p>
